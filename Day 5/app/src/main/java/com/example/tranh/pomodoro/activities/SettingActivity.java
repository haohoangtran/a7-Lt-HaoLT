...
//        String s=getResources().getString(R.string.work_time_25_min);
        textViewWork.setText(String.format(getResources().getString(R.string.work_time_25_min)+"",seekBarTimeWork.getProgress()));
        textBreak.setText(String.format(getResources().getString(R.string.break_10_mins)+"",seekBarTimeBreak.getProgress()));
        textLong.setText(String.format(getResources().getString(R.string.long_break_20_min)+"",seekBarBreakLong.getProgress()));
    }
